...
- 種類: Raman
- 横軸単位: cm<sup>-1</sup>
- ゼロ圧ピーク位置の初期値: 464.4 cm<sup>-1</sup>（あくまで初期値です。実際の測定系・試料で測ったゼロ圧位置に
  置き換えてください）

## 圧力スケール（2種類、いずれも温度補正は任意）

- **Schmidt and Ziemann 2000**（2次式、~23℃付近） — <i>Am. Min.</i>、
  0 < Δν ≤ 20 cm<sup>-1</sup>（~2.1 GPaまで）で有効
...
- **Schmidt and Ziemann 2000**（線形近似、9 cm<sup>-1</sup>/GPa） — <i>Am. Min.</i>、100 – 560℃で一定と報告
  [DOI: 10.2138/am-2000-11-1216](https://pubs.geoscienceworld.org/msa/ammin/article/85/11-12/1725/133600/In-situ-Raman-spectroscopy-of-quartz-A-pressure)
...
（Δν ≤ 20 cm<sup>-1</sup>、およそ2.1 GPaまで）専用、線形近似は100 – 560℃の高温域専用です。実験条件に応じて
選び分けてください。
:::
